...
const AZURE_BACKEND_URL = 'https://langvault-ehefa6cje7ckegd8.centralindia-01.azurewebsites.net'; // Replace with your actual Azure URL
...
async function handleFormSubmit(e) {
    ...
    try {
        ...
        showToast(result.message || 'Translation completed successfully!', 'success');
            ...
            <div class="results-card glass-card">
                <div class="results-header">
                    ...
                    <div class="results-info">
                        ...
                        <p>${result.translation_stats?.total_pages || 1} pages successfully processed</p>
                    </div>
                ...
                <div class="translation-stats">
                    <div class="stat-item">
                        ...
                        <div class="stat-info">
                            <span class="stat-value">${result.translation_stats?.total_pages || 1}</span>
                    ...
                    <div class="stat-item">
                        ...
                        <div class="stat-info">
                            <span class="stat-value">${result.translation_stats?.target_language || language}</span>
                    ...
                    <div class="stat-item">
                        <i class="fas fa-check-circle"></i>
                        <div class="stat-info">
                            <span class="stat-value">${result.translation_stats?.successful_translations || 1}</span>
